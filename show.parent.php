<?php
@session_start();
$activeTitle = "Show Parent";
$activePage = "show.parent";
require 'up.html.php';
...
// Sonucu ekrana yazdırma
    ...
    <tr>
      ...
      <td><a href='show.parent.php?removeparentid={$parent['userid']}'onclick='return confirm(\"Are you sure you want to delete {$parent['username']}?\")' class='btn btn-danger btn-sm'>Delete <i class='bi bi-trash'></i></a></td>
   </tr>
  ";
}
?>
